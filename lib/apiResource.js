...
module.exports.prototype.makeRequest = function(verb,path,data) {
...
module.exports.prototype.post = function(path,data){
	return this.makeRequest("POST",path,data);
}
module.exports.prototype.get = function(path,data){
	return this.makeRequest("GET",path,data);
}
module.exports.prototype.put = function(path,data){
	return this.makeRequest("PUT",path,data);
}
module.exports.prototype.delete = function(path,data){
